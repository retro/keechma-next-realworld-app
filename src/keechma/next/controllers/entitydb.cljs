...
(deftype ReadOnlyCursor [state* query-fn]
  IDeref
...
(deftype EntityDbApi [ctrl state*]
  ...
  (get-entity* [_ entity-type id]
    (->ReadOnlyCursor state* #(get-entity % entity-type id)))
  (get-entity* [_ entity-type id queries]
    (->ReadOnlyCursor state* #(get-entity % entity-type id queries)))
  (get-named* [_ entity-name]
    (->ReadOnlyCursor state* #(get-named % entity-name)))
  (get-named* [_ entity-name queries]
    (->ReadOnlyCursor state* #(get-named % entity-name queries)))
  (get-collection* [_ collection-name]
    (->ReadOnlyCursor state* #(get-collection % collection-name)))
  (get-collection* [_ collection-name queries]
    (->ReadOnlyCursor state* #(get-collection % collection-name queries))))
