(ns workshop.core
  (:require [keechma.next.helix.core :refer [KeechmaRoot]]
            ...
            ["react" :as react]
            ["react-dom" :as rdom]
            [workshop.app :refer [app]]
            [workshop.ui.main :refer [Main]]
...
(defn render-app [root app-instance]
  (.render root ($ react/StrictMode
                  ($ KeechmaRoot {:keechma/app app-instance}
                    ($ Main)))))
